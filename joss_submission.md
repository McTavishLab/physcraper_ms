...
or that is useful in any way for phylogenetics:
    ...
    @meng2015sotree, and @meng2014rapidtree, all cite phylota using the exact same
    ...
    been developed to mine the massive amount of information stored in GenBank", along with its R version [phylotaR; @bennett2018phylotar] and restez <https://www.rdocumen-tation.org/packages/restez/versions/1.0.0>.

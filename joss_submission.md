...
Genetrating phylogenies is not easy.
The process of phylogenetic reconstruction implies many steps that can be generalized to the following:
1. Obtention of molecular or morphological character data -- get DNA from some organisms and sequence it, or get it from an only repository, such as GenBank.
1. Assemble a hypothesis of homology that can be used to reconstruct phylogenetic relationships -- Create a matrix of your character data, by aligning the sequences, in the case of molecular data.
1. Analyse this hypothesis of homology to infer relationships among the organisms you are studying -- Use different available programs to infer molecular evolution, trees and times of divergence.
1. Discuss the inferred relationships in the context of previous hypothesis, the biology and biogeography of the organisms, etc. -- Answer the question, *is this solution fair/reasonable?*
...
Automatizating the assembly of the character data set is a crucial step towards
reproducibility in a task that was otherwise primarily artisanal and hence largely
non-reproducible.
...
Even the phylogenetic community has some reserves towards these tools.
...
## Study tree and alignment downloading

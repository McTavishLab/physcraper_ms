...
67 are also in updated Gottlieb2005.

\begin{figure}
\includegraphics[width=1\linewidth]{docs/figs/ilex-results} \caption{A phylogenetic tree is the main result of a Physcraper analysis.}\label{fig:results}
\end{figure}
...
\emph{COMPARE WITH PERFORMANCE OF OTHER PIPELINES FOR SEQUENCE SCRAPING}
\emph{WHY WE DID NOT MAKE A BENCHMARK COMPARISON?}

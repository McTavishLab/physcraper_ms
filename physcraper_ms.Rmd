...
to go to the annual conference of X, and probably you will only find
different and contrasting opinions in there, too.
Somewhere along the months or even years you've been on this task, you landed into the
the OToL website. You found in there some or all the published trees of X, along
with a tree that has been labeled as the best tree by volunteered curators (and ideally experts on X). What do you do?

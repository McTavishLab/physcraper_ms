...
|-----|------|:------:|:------:|:------:|
| Phylota | @sanderson2008phylota | 122 studies | finding homologs on GenBank database | Supermatrix |
| AMPHORA | @wu2008simple | 458 studies | mines public genomic data and constructs phylogenies using whole genomic data | Supermatrix?? |
| PHLAWD | @smith2009mega | 234 studies | Baited search | Supermatrix |
...
| pyPhlawd | @smith2019pyphlawd | 6 studies | baited analyses | Supermatrix or gene tree |
...
According to @ceron2019phylotol, both AMPHORA and PHLAWD

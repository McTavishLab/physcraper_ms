...
and can be more prevalent in automatically assembled dtasets than in manually curated ones.
...
Initial understanding about scientific data is constantly challenged and reframed by new data and analyses.
Physcraper provides a framework for reproducible phylogenetics that has the
potential to consistently contextualize new knowledge in the light of previous knowledge,

...
Physcraper is the first tool for interoperability in phylogenetic analyses (???)
As a tool for automatization of phylogenetic reconstruction from molecular databases,
...
public molecular data. Phylota \cite{sanderson2008phylota},
and PHLAWD \cite{smith2009mega} are the first ones and have been cited and used
the most for actual phylogenetic reconstruction and mining of databases. These are
strong tools that will probably still have a great potential in their recent updated versions
(phylotar \cite{bennett2018phylotar} and PyPHLAWD \cite{smith2019pyphlawd}).
They focus on generating full phylogenies \textit{de novo},
...
phylogenetic estimates, which requires more manual adjustment later and difficults
comparison with previous phylogenetic information.

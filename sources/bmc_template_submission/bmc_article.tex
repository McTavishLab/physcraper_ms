...
public molecular data available. Unlike phylogenetic placement approaches \cite{berger_performance_2011, matsen_pplacer_2010},
...
sequence length cutoff parameter, based on said information.
...
Physcraper facilitates the exploration of alternative aligning tools to determine their effect on phylogenetic inferences.
...
showcasing the utility and importance of good data sharing practices and open science for phylogenetics, biology and science.
...
We thank the members of the current OpenTree development team (MH, KC, MTH, and JA),
and the ``short bar" Science
and Engineering Building 1, UCM, Bloise-McTavish joint lab paper discussion group for valuable

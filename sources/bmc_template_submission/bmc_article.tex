...
taxonomic resource \cite{rees2017automated}, streamlining connections across biological databases.
...
as open access services for use by the general public \cite{opentreeAPIs}.
...
\cite{mctavish2015phylesystem}) by human curators - the remaining 1.4 million taxa are placed
in the synthetic tree based on taxonomy.

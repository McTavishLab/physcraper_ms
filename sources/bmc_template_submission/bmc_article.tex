...
Physcraper's main goal is to use its interoperability framework to build upon published
alignments and phylogenies
to extend existing phylogenetic inferences with sequence data available in public
...
taxonomic resource \cite{rees2017automated}, effectively streamlining connections between phylogenies and biological data.

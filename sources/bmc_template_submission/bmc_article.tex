...
It currently consists of HOW MANY modules, classes, methods and functions.
For testing the quality of the Python code syntax we used Pylint \cite{pylintWeb, pylintManual}.

...
It contributes to the democratization of the field by facilitating access to phylogenetic knowledge for ecologists and other non-specialists.
...
software and compare results using Physcraper tools.
...
using BLAST's local search algorithm, but that may be important for phylogenetic inference.
...
longer under active development, is challenging to install and run, and has produced
 very few published phylogenetic analyses since its publication.
...
phylogenies to address challenges overarching both fields of ecology and evolution, such as

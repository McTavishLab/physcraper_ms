...
context for our biological observations \cite{Dobzhansky maybe}.
A challenge for phylogenetic reconstruction
...
largely non-overlapping homology hypotheses across taxa \cite{BLA}, creating challenges for
reconstructing the shared evolutionary history of taxa separated phylogenetically
at deep scales \cite{BLA}.

While phylogenomics tackles this problem by focusing on targeted capture of informative
regions \cite{andermann2020guide, it is expensive. Few labs around the world can afford
to implement it for all their study groups, or at all. It does not contribute to
democratization of research yet.
...
How much of this is available on OpenTree??
...
%% <!-- MTH: you probably need some details about the hardware, given the fact hat you are discussing running times -->

...
Updating existing phylogenies with molecular sequence data that has never been
incorporated into any phylogenetic estimate provides the opportunity to capture
the evolutionary history of many taxa.
...
Physcraper can be used to update a starting tree and single locus alignments
with public DNA data, and link the tips in these trees to a unified, interoperable
...
the tree of life that, but this data either has not been analysed or the analyses
...
Physcraper improves on previous work in automating phylogenetics by leveraging
...
link phylogenies mapped to a standardized taxonomy \cite{mctavish2015phylesystem}, to alignments

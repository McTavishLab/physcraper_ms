...
used the Pylint software following instructions from their website \citep{pylintWeb}
 and manual \citep{pylintManual}, with a "".pylintrc" configuration file.

We improved code's syntax on modules with low Pylint scores and fixed code errors by
...
%This suggests that the samples might represent two ifferent species, but further analyses should be conducted
A visual comparison

...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Tue Apr  6 13:04:05 2021
%%                                      %
...
the \DIFdelbegin \DIFdel{hollies}\DIFdelend \DIFaddbegin \DIFadd{genus }\textit{\DIFadd{Ilex}}\DIFaddend .
...
, }\DIFdelend or SVD Quartets \cite{chifman2014quartet}).
...
\DIFaddbegin \DIFadd{The updated holly tree is based on a single marker, so we expected for it to be
not as well resolved as trees using multiple markers. Nevertheless, all samples
corresponding to the ingroup cluster together in a monophyletic group. We also
note that most samples belonging to the same species also cluster together forming
monophyletic groups. Notable exceptions are Ilex theeizans, which also appears as
non-monophyletic in the original Gottlieb et al. 2005 tree. A visual comparison
of the Yao et al. 2020 tree and the original Gottlieb et al. 2005 tree suggests
that the relationships within the genus Ilex are still being determined, and that

...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Mon May  3 19:12:49 2021
%%                                      %
...
}\DIFaddend , and links \DIFdelbegin \DIFdel{the tips in these }\DIFdelend \DIFaddbegin \DIFadd{tip taxon labels in the updated trees to a unified, interoperable
taxonomic resource \mbox{%DIFAUXCMD
\cite{rees2017automated}}\hspace{0pt}%DIFAUXCMD
, streamlining connections between phylogenies and biological data.
Physcraper links tip taxon labels in the updated }\DIFaddend trees to a unified, interoperable
taxonomic resource \cite{rees2017automated}\DIFaddbegin \DIFadd{, eefectively streamlining connections between phylogenies and biological data}\DIFaddend .
...
as open access services for the general public \mbox{%DIFAUXCMD

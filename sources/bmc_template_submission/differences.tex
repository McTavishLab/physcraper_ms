...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Thu Mar  4 16:03:56 2021
%%                                      %
...
with the main goal of building \DIFdelbegin \DIFdel{on published alignments and extending }\DIFdelend \DIFaddbegin \DIFadd{upon published alignments to extend }\DIFaddend existing
...
}\DIFdelend \DIFaddbegin \DIFadd{Yao2020 }\DIFaddend tree is the best sampled phylogeny yet available for
the \DIFdelbegin \DIFdel{hollies}\DIFdelend \DIFaddbegin \DIFadd{genus }\textiy{\DIFadd{Ilex}}\DIFaddend .
...
The updated \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{gottlieb2005molecular} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{Gottlieb2005 }\DIFaddend tree (Figure 2) displays
all 41 distinct
...
(Figure 2).
\DIFdelbegin \DIFdel{For comparison, }\DIFdelend \DIFaddbegin \DIFadd{The Yao2020 tree }\DIFaddend \cite{yao2020phylogeny} also contains all 41 distinct taxa
...
}\DIFaddend 67 \DIFaddbegin \DIFadd{taxa }\DIFaddend are also in \DIFdelbegin \DIFdel{updated }\DIFdelend \DIFaddbegin \DIFadd{the Physcraper updated Gottlieb2005 tree }\DIFaddend \cite{gottlieb2005molecular}.
While \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{yao2020phylogeny} }\hspace{0pt}%DIFAUXCMD
also used
}\DIFdelend \DIFaddbegin \DIFadd{the Yao2020 tree \mbox{%DIFAUXCMD
\cite{yao2020phylogeny} }\hspace{0pt}%DIFAUXCMD
...
\cite{yao2020phylogeny}}\hspace{0pt}%DIFAUXCMD
. }\DIFdelend \DIFaddbegin \DIFadd{additional }\textit{\DIFadd{Ilex}} \DIFadd{taxa.
}\DIFaddend 

\DIFaddbegin \subsection*{\DIFadd{Verification test}}

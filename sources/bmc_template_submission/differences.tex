...
%DIF DEL sources/bmc_template_submission/bmc_article_submission_2021-01-08.tex   Tue Apr 27 23:58:14 2021
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Wed Apr 28 12:43:07 2021
%%                                      %
...
\cite{piel2009treebase, vos2012nexml, piel2018treebasedmp, treebase_website, supertreebase}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ,
...
to alignments
from TreeBASE\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{sanderson1994treebase}}\hspace{0pt}%DIFAUXCMD
...
alignments available on TreeBASE\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{piel2009treebase}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend .
...
\begin{figure}[h!]
  \caption{A) Phylogeny updated with Physcraper \DIFaddbeginFL \DIFaddFL{using a starting phylogeny and alignment }\DIFaddendFL from
  ...
  database via local BLAST of all sequences in the \DIFdelbeginFL \DIFdelFL{original alignment that generated
  tree in B}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Gottlieb2005 internal transcribed
  spacer DNA region (ITS}\DIFaddendFL ) \DIFaddbeginFL \DIFaddFL{alignment}\DIFaddendFL ,

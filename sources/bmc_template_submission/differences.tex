...
%DIF DEL sources/bmc_template_submission/bmc_article_submission_2021-01-08.tex   Mon May  3 16:58:33 2021
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Mon May  3 17:21:53 2021
%%                                      %
...
Physcraper's main goal is to use its interoperability framework to build upon }\DIFaddend published alignments and \DIFdelbegin \DIFdel{extending }\DIFdelend \DIFaddbegin \DIFadd{phylogenies
to extend }\DIFaddend existing phylogenetic inferences with more data and taxa\DIFaddbegin \DIFadd{, which improve our
...
}\DIFaddend , and links \DIFdelbegin \DIFdel{the tips in these }\DIFdelend \DIFaddbegin \DIFadd{tip taxon labels in the updated }\DIFaddend trees to a unified, interoperable
taxonomic resource \cite{rees2017automated}\DIFaddbegin \DIFadd{, streamlining connections across biological databases}\DIFaddend .
...
as open access services for use by the general public \mbox{%DIFAUXCMD
...
}\DIFaddend 90,000 are supported by \DIFdelbegin \DIFdel{phylogenies }\DIFdelend \DIFaddbegin \DIFadd{publicly available expert phylogenetic data, uploaded to OpenTrees' database (the Phylesystem
\mbox{%DIFAUXCMD
\cite{mctavish2015phylesystem}}\hspace{0pt}%DIFAUXCMD
) by human curators }\DIFaddend - the remaining 1.4 million taxa are placed
in the \DIFaddbegin \DIFadd{synthetic }\DIFaddend tree based on taxonomy.
...
widely }\DIFaddend non-overlapping homology hypotheses across taxa\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{jones2016targeted}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend ,
creating challenges for phylogenetic reconstruction \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{jones2016targeted}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .

...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Tue May  4 01:02:38 2021
%%                                      %
...
\DIFaddbegin \DIFadd{Increased taxonomic sampling is known to improve
...
with the main goal of building \DIFdelbegin \DIFdel{on }\DIFdelend \DIFaddbegin \DIFadd{upon }\DIFaddend published alignments and \DIFdelbegin \DIFdel{extending }\DIFdelend \DIFaddbegin \DIFadd{phylogenies
...
Physcraper links tip taxon labels in the updated }\DIFaddend trees to a unified
\DIFdelbegin \DIFdel{, interoperable
}\DIFdelend taxonomic resource \cite{rees2017automated}\DIFaddbegin \DIFadd{, effectively streamlining connections
...
Physcraper has a framework for connecting }\DIFdelend \DIFaddbegin \DIFadd{, among many others.
...
of }\DIFaddend updated phylogenies with data from \DIFdelbegin \DIFdel{any
}\DIFdelend \DIFaddbegin \DIFadd{different and independent }\DIFaddend biological database.

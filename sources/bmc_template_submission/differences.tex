...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Fri May 28 15:55:47 2021
%%                                      %
...
highlighting the importance of data sharing }\DIFdelend \DIFaddbegin \DIFadd{contextualize new knowledge in the light of previous understanding,
showcasing the utility and importance of good data sharing practices }\DIFaddend and open science for phylogenetics, biology and science.
...
We thank the members of the \DIFaddbegin \DIFadd{current }\DIFaddend OpenTree development team \DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{(MH, KC, MTH, and JA),
and }\DIFaddend the ``short bar" Science
and Engineering Building 1, UCM, \DIFaddbegin \DIFadd{Bloise-McTavish }\DIFaddend joint lab paper discussion group for valuable

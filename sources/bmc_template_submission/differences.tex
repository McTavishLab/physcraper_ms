...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Tue Apr 27 23:57:14 2021
%%                                      %
...
{%DIFAUXCMD
\DIFdelFL{A) Phylogeny updated with Physcraper from original
  \mbox{%DIFAUXCMD
\cite{gottlieb2005molecular} }\hspace{0pt}%DIFAUXCMD
tree in B.
...
%DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \caption{\DIFaddFL{A) Phylogeny updated with Physcraper using a starting phylogeny and alignment from
  \mbox{%DIFAUXCMD
\cite{gottlieb2005molecular} }\hspace{0pt}%DIFAUXCMD
(Gottlieb2005 data in text).
  Tips in original alignment and new tips added with Physcraper are depicted in
  black and red, respectively. Physcraper obtained sequences from the GenBank
  database via local BLAST of all sequences in the Gottlieb2005 internal transcribed
  spacer DNA region (ITS) alignment,
  ...
  analysis performed using OpenTree's conflict tool \mbox{%DIFAUXCMD

...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Tue Mar  2 15:25:15 2021
%%                                      %
...
(study 1091 \cite{treebase1091}). The tree \DIFdelbegin \DIFdel{sampling }\DIFdelend \DIFaddbegin \DIFadd{samples }\DIFaddend 41 species\DIFdelbegin \DIFdel{is also }\DIFdelend \DIFaddbegin \DIFadd{, is }\DIFaddend available from
...
tree }\DIFdelend \DIFaddbegin \DIFadd{tree from \mbox{%DIFAUXCMD
\cite{yao2020phylogeny} }\hspace{0pt}%DIFAUXCMD
}\DIFaddend is the best sampled phylogeny yet available for
the hollies.
...
to incorporate 18 taxa that were not in \cite{yao2020phylogeny}\DIFaddbegin \DIFadd{.
}
...
in the 3 sequences published in the original alignment}\DIFaddend .

...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Tue Apr  6 13:52:23 2021
%%                                      %
...
geographical locations for taxa from the GBIF \cite{gbif_secretariat_gbif_2019}\DIFaddbegin \DIFadd{.
...
\DIFadd{The updated holly tree is based on a single marker, so we expect for it to be
...
increased taxon sampling is helping with it}\DIFaddend .

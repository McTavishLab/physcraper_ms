...
%DIF DEL sources/bmc_template_submission/bmc_article_submission_2021-01-08.tex   Wed Apr 28 22:42:18 2021
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Wed Apr 28 22:53:06 2021
%%                                      %
...
selbach2009new}, but only two have data openly available\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
...
and alignment to update relationships in the genus }\textit{\DIFadd{Ilex}}\DIFadd{,
...
\DIFadd{Our example application of Physcraper to update a phylogeny of the genus }\textit{\DIFadd{Ilex}} \DIFadd{is based on a

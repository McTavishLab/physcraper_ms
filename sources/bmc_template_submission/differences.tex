...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Sat Apr 24 16:37:09 2021
%%                                      %
...
can be \DIFdelbegin \DIFdel{leveraged }\DIFdelend \DIFaddbegin \DIFadd{used }\DIFaddend as seeds to mine molecular databases, and as ``jump-start'' alignments
...
\DIFadd{Rigorous analyses of multiple loci allow for more complex evolutionary models
...
than analyses of large genomic data sets, and can provide better evolutionary estimates}\DIFdelend .
\DIFaddbegin \DIFadd{We have included a script (``multi\_locus.py'') and examples of how to automatically

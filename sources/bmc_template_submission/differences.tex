...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Fri May 28 14:19:42 2021
%%                                      %
...
We believe this is a key step to successfully establish an open, reproducible workflow for phylogenetics\DIFdelbegin \DIFdel{,
facilitating }\DIFdelend \DIFaddbegin \DIFadd{.
It contributes to the democratization of the field by facilitating access to }\DIFaddend phylogenetic knowledge for ecologists and other non-specialists\DIFdelbegin \DIFdel{, effectively
democratizing phylogenetic studies}\DIFdelend .
...
software \DIFaddbegin \DIFadd{and compare results using Physcraper tools}\DIFaddend .
...
\DIFdelbegin \DIFdel{by }\DIFdelend \DIFaddbegin \DIFadd{using }\DIFaddend BLAST's local search algorithm, but that may be important for phylogenetic inference.
...
longer under active development, is challenging to install and run, and has \DIFdelbegin \DIFdel{resulted
in very few }\DIFdelend \DIFaddbegin \DIFadd{produced
 very few published }\DIFaddend phylogenetic analyses since its publication.
...
phylogenies \DIFdelbegin \DIFdel{which can }\DIFdelend \DIFaddbegin \DIFadd{to }\DIFaddend address challenges overarching both fields of ecology and evolution, such as

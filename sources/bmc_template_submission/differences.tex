...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Wed Apr 28 23:49:10 2021
%%                                      %
...
run to test if we would recover the pruned tips. Physcraper automatically dropped
from the alignment the taxa pruned from the phylogeny to perform the BLAST searches.

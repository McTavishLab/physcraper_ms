...
%DIF ADD sources/bmc_template_submission/bmc_article.tex                         Fri Apr 23 12:21:38 2021
%%                                      %
...
we used the Pylint \mbox{%DIFAUXCMD
\cite{pylintWeb, pylintManual} }\hspace{0pt}%DIFAUXCMD
software with a configuration file.
...
As of now, all modules have a Pylint score of 10/10.
}

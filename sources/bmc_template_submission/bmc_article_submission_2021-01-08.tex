...
largely non-overlapping homology hypotheses across taxa,
...
to alignments
from TreeBASE, and data from GenBank.
...
selbach2009new}, but only two have data openly available \cite{gottlieb2005molecular, yao2020phylogeny}.

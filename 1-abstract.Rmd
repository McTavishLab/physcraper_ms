...
1. We hope that the Physcraper workflow demonstrates the benefits of opening results in phylogenetics, encouraging more researchers to strive for better data sharing practices. Physcraper can be used with any OS. Detailed instructions for installation and

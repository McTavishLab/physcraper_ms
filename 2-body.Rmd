...
focus mainly on generating full trees *de novo* for regions of the Tree of
...
It can also link to various biological databases, such as GBIF, the Paleobiology Database, etc, by leveraging the integrated taxonomy from OpenTree [@rees2017automated], a resource that is allowing us to reach decade-long dreams of "exploring and analysing biodiversity at an accelerated pace, and returning systematics into the mainstream of science" [@wilson2003encyclopedia].
...
sistematizing molecular (and other) databases, i.e., curating taxonomic assignations [@san2010molecular],

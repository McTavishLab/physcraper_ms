...
To illustrate the utility of Physcraper we will use a scenario in which a user is interested in a particular group, e.g., the genus *Ilex*, which encompasses between 400-700 living species, and is the only extant clade within the family Aquifoliaceae, order Aquifoliales of flowering plants, commonly known as "hollies".

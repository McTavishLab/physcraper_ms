...
We will illustrate the utility of Physcraper in here with one use-case scenario in which a user is interested in a particular group, e.g., the genus *Ilex*, encompassing between 400-600 living species, is the only extant clade within the family Aquifoliaceae, order Aquifoliales of flowering plants, commonly known as "hollies".

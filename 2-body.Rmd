...
More than a decade ago, the National Center for Biodiversity Information (NCBI) molecular database, GenBank, released its version number 159 (April 15, 2007). With 72 million DNA sequences, it was estimated to have the potential to resolve evolutionary relationships of most of the 241 000 distinct taxa covered in it [about `r round(236023/240708, digits=4)*100`% of taxa in the NCBI taxonomy; @sanderson2008phylota] which in turn represent only about 10% of all extant described biodiversity [taking a conservative estimate of extant diversity; @scott2011ncbi; @federhen2003taxonomy].
In comparison, the current GenBank release number 238 (June 15, 2020) has tripled in size, hosting data for more than 217 million DNA sequences [(See GenBank's release website)](https://ftp.ncbi.nih.gov/genbank/gbrel.txt). Yet, the phylogeneyic potential of the database has not been attained yet, with data on phylogenetic relationships available for about 90 000 taxa [@hinchliff2015synthesis; CURRENT SYNTH TREE CITATION], representing only one third of the taxonomic diversity with data available a decade ago (or 3% of the whole diversity) ALSO COMPARE WITH NUMBER OF TAXA REPRESENTED IN GENEBANK TODAY. Some of this discrepancy is explained by the many phylogenies that are not publicly shared [@drew2013lost; @magee2014dawn, @mctavish2018bioessay]. However, most recently published large trees have been made available in recent years, indicating there is also a lag between the amount of new DNA data generated and the analysis of these data in a phylogenetic context.

Computational tools are crucial to making sense of the massive amount of data in molecular databases. "Pipelines" that automate similarity based identification of DNA homologs and assembly of molecular homology hypotheses, i.e., molecular alignments [@sanderson2008phylota; @antonelli2017toward; @smith2009mega] have been a very important incorporation to the field of phylogenetics in many ways, particularly because they represent a clear step towards reproducibility in the field. They have been widely applied to study the evolutionary relationships among different organisms, from vertebrates, to plants and bacteria (TABLE OF PIPELINES AND STUDIES THAT HAVE USED THEM?? maybe supplementary data).

Still, most published phylogenies to date have been inferred using alignments that have been assembled and curated "by hand" [@morrison2009would]. GETTING AN ESTIMATE OF TOTAL PUBLISHED PHYLOGENIES WOULD BE NICE.
Automated approaches often suffer from errors in homology inference that could be rapidly caught by human oversight. CITATION

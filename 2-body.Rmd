...
Figure \@ref(fig:results) shows results from updating one alignment from the Gottlieb2005 tree. It contains all 41 distinct taxa from the original Gottlieb2005 tree plus 231 new tips, contributing phylogenetic data to 84 additional taxa within *Ilex*. The tree is 99% resolved, however, a large portion of branches are negligibly small (133 branches < 0.00001 substitution rate units), appearing as unresolved nodes in the figure.

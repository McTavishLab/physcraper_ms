...
- The software MUSCLE [@edgar2004muscle] is used by default to perform sequence alignments. It has to be installed by the user, previous to running physcraper.
